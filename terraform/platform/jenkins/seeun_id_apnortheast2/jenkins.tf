module "jenkins" {
  ...
  ssl_certificate_id       = var.r53_variables.star_se_terraform_devart_tv_acm_apne2_arn
  route53_external_zone_id = var.r53_variables.se_terraform_devart_tv_zone_id
  ...
  ingress_cidr_blocks = ["217.146.114.196/32"]
